...
def mi_styler_comp(mi_styler):
    ...
    other = mi_styler.arvores.agg(["mean"])
...
def test_inherited_copy(mi_styler, deepcopy):
    ...
    custom_styler = CustomStyler(mi_styler.arvores)
    custom_styler_copy = (
...
def test_clear(mi_styler_comp):
    ...
    clean_copy = Styler(styler.arvores, uuid=styler.uuid)
